...
c_proto: main.o list.o connect.o irc_getopt.o channel.o user.o channel.o
	$(CC) -lpthread -o c_proto main.o list.o connect.o irc_getopt.o channel.o user.o
main.o: main.c
...
clean:
	rm main.o list.o connect.o irc_getopt.o channel.o user.o
